...
import windRoadLogo from '../../assets/WindRoad_logo_test.png';
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <img src={windRoadLogo} alt="WindRoad 로고" className="h-12 w-auto mr-2" />
              <Link to="/plan" className="text-xl font-bold text-primary">WINDROAD</Link>
            </div>
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link to="/list" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                여행 계획하기
              </Link>
            </div>
          </div>
